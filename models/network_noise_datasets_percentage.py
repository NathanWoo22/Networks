...
for noise in noise_percentage:
    ...
    checkpoint_path = "epos_noise_plots_percentage/" +str(100 *(noise)) + "/model_checkpoint.h5"
    ...
    with open("epos_noise_plots_percentage/" +str(100 * (noise)) + "/history.txt", 'w') as file:
